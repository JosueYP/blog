...
import { UsuarioRutas } from './http/usuario/rutas';
import { CategoriaRutas } from './http/categoria/rutas'
import { AlbumRutas } from './http/album/rutas';
import { ImagenRutas } from './http/imagen/rutas';
import { TagRutas } from './http/tag/rutas'
import { ResenaRutas } from './http/resena/rutas';
import { AlbumTagRutas } from './http/albumtag/rutas';
import { CateCateRutas } from './http/catecate/rutas';
...
export class ServerExpress {
	...
	private rutas() {
		...
		this.app.use(new CategoriaRutas().ruteador);
		this.app.use(new AlbumRutas().ruteador);
		this.app.use(new ImagenRutas().ruteador);
		this.app.use(new ResenaRutas().ruteador);
		this.app.use(new TagRutas().ruteador);
		this.app.use(new AlbumTagRutas().ruteador);
		this.app.use(new CateCateRutas().ruteador);
	}
